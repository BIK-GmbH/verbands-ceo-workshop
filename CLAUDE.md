...
- **Module:** 0 Auftakt · 1 Analyse: Need to Move · 2 Vision · 3 Zielbild · 4 Realitätscheck FBS · 5 Wirtschaftlichkeit & Argumentation · 6 Roadmap · 7 Commitment · 99 Anhang (59 Folien, siehe `src/lib/manifest.ts`; die App leitet die Zahl überall aus dem Manifest ab). Tag 2 beginnt mit 04.00 „Rückblick Tag 1" (`DayRecap`, liest Poster 1–3, Barometer, Zahlen und offene `q-…`-Fragen live aus dem Protokoll; Logik in `src/lib/day-recap.ts`)
