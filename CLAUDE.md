...
Interaktive **Konzept-Werkstatt** (Schulungs- + Erarbeitungsplattform) für einen
**Halbtags-Vorstandsworkshop (~3,5 Std)** zum BIK-Betriebsmodell
**„Der KI-augmentierte Verbands-CEO"**. Zielgruppe: der Vorstand des
**Fachverbands Betonbohren und -sägen Deutschland e. V. (FBS)**, Darmstadt.
Veranstalter: **BIK GmbH** (Christian Hubmann) in Kooperation mit
**DIE INNOVATIONSWERKSTATT (Team Prof. Venker) GmbH, Amberg**.
...
- **Format:** Halbtag, ~3,5 Std, erarbeitend (eine „Erarbeiten"-Übung pro Modul)
- **Module:** 0 Auftakt · 1 Ausgangslage · 2 Aufgaben & Rolle · 3 Zielarchitektur · 4 Governance · 5 Förderung/Roadmap · 6 Beschluss · 7 Ergebnis · 99 Anhang (40 Slides)
