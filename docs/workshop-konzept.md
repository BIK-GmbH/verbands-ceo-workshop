# Workshop-Konzept „KI-Geschäftsführer: Fiktion oder Realität?"

Stand: 11.09.2026 · Grundlage: Kurzprotokoll Workshop-Konzeption (10.09.2026) und 7 Ablaufblätter („Verbandssitzung", Fotos vom 10.09.2026).
Diese Datei ist die inhaltliche Referenz für alle Folien. Alte Folien liegen nur noch als Materialquelle unter `docs/old-content/`.
...
5. **Arbeitsformen:** diskussionsorientiert, **Plenum als Grundform**, dazu **Stillarbeit** (z. B. Top-5-Karten in 01.03, Möglichkeiten in 02.07, optional Top-3-Prioritäten in 06.02), **Kleingruppen bzw. Paare** (5× Warum in Zweiergruppen, Aufgaben-Cluster in drei Kleingruppen, Pro/Contra mit Befürworter und Advocatus Diaboli) und die **Einzelinterviews** (KI-Interview) zu Beginn von Phase 1. Keine Festlegung auf Punkte-Kleben; die Priorisierungsmethode wählt die Moderation (z. B. Handzeichen oder Punkte).
   **Ergebnisse effizient in die Plattform:** Karten werden reihum vorgelesen und im **Karten-Modus** (`CardCollector`) per Diktat übernommen, jede Sprechpause wird eine Karte. Kleingruppen stellen im Plenum vor (in drei Sätzen), die Moderation diktiert oder tippt in die Eingabefelder. Auf Klick glättet die KI die Karten (Erkennungsfehler, Dubletten), ordnet sie den konfigurierten Dimensionen zu (in 02.07: Kategorie Wissen · Assistenz · Automatisierung · Analyse und Zeithorizont Heute · Morgen · Übermorgen, Vorschlag für alle Karten auf einmal, Wortlaut unverändert, Korrektur je Karte) und clustert sie zu Themenfeldern (01.03 → Feld Problemfelder in 01.04). Die Spielregeln (00.07) tragen diese Arbeitsformen.
6. **Gemeinsames Wir.** Keine Rollentrennung „Moderation fragt, Teilnehmende antworten". Grundprinzip der ganzen Veranstaltung: **Wir entwickeln die relevanten Fragen gemeinsam und suchen dann gemeinsam die Antworten.** Alle Leit-, Prüf- und Interviewfragen auf den Folien sind Vorschläge, die die Runde schärft und um eigene Fragen ergänzt; der Baustein „Eigene Frage / Aufgabe" im Live-Protokoll nimmt sie auf und gibt jeder Frage ein eigenes Antwortfeld. Im sichtbaren Folientext durchgehend „wir/uns/unsere" statt „ihr/euch/eure"; die Moderation hält den Rahmen, die Inhalte kommen von allen. Verankert auf 00.07 (eigene Kachel und Spielregel „Wir fragen, wir antworten") und kurz auf den Phasen-Überblicksfolien. In den SpeakerNotes bleibt die direkte Ansprache an Harald und Stefan erlaubt, aber auch dort gilt: gemeinsam entwickeln und eigene Fragen einsammeln statt abfragen.
...
| Zeit | Block |
|---|---|
| 12:00–13:00 | Get together & Lunch (Auftakt 12:45–13:00) |
| 13:00–14:30 | Phase 1 · Analyse: Need to Move |
| 14:30–15:00 | Pause |
| 15:00–16:30 | Phase 2 · Vision: Möglichkeitsraum |
| 16:30–16:45 | kurze Pause |
| 16:45–18:15 | Phase 3 · Zielbild: Unser KI-Geschäftsführer |
...
| 11:45–12:15 | Phase 7 · Commitment: Fiktion oder Realität? |
| 12:15–12:30 | Abschluss & nächste Schritte |

## Die Phasen im Detail

### Auftakt (Modul 0)
Anlass, Leitfrage, die Phasen, Spielregeln, Poster-Prinzip, App (Protokoll, Diktat). **Vorher-Barometer:** „KI-Geschäftsführer: Fiktion oder Realität?" (Abstimmung, wird in Phase 7 wiederholt).

### Phase 1 · Analyse: Need to Move (90 Min) — Modul 1
- **Kernfrage:** Welches Problem wollen wir wirklich lösen? Warum muss sich der Verband überhaupt verändern?
- **Output:** Ein gemeinsam bestätigtes, klar formuliertes Kernproblem → **Need-to-Move-Poster**.
- **Einstieg KI-Interview (ca. 5 Min pro Person, parallel auf eigenen Geräten):** Wie stehst du grundsätzlich zum Thema KI? Welche fünf Begriffe fallen dir spontan zu KI ein? Wie schätzt du deine eigene KI-Kompetenz ein? Wie relevant ist KI für den Verband heute – und wie relevant wird sie morgen sein? Wo siehst du konkrete Einsatzgebiete für KI? Vor welchen Top-Herausforderungen steht der Verband in den nächsten 3–5 Jahren – und wo könnte KI dabei konkret helfen?
...
- **Ablauf (Ablaufblatt 02):** 5 Min Ausgangspunkt Kernproblem · 30 Min **Experteninput Dr. Stefan Reinheimer:** HEUTE (was ist schon möglich?) · MORGEN (was wird realistisch?) · ÜBERMORGEN (was könnte möglich werden?) zu KI-Modelle & Agenten, Automatisierung & Prozesse, Wissenssysteme & Daten, Schnittstellen & Integrationen, Plattformen & Architekturmodelle, Grenzen & Voraussetzungen; Einordnung nach Nutzenpotenzial und Umsetzbarkeit · darin **Wissen als Grundlage** mit Wissensplattform sowie RAG und K-RAG (Folien 02.09–02.11) und die Frage Cloud-Modell oder lokales Modell (02.12) · 20 Min Fragen an Stefan (Kann die KI das? Wo sind Grenzen? Was bräuchte es?) · 15 Min Möglichkeiten sammeln: 5 Min Stillarbeit auf Karten, 10 Min reihum vorlesen im Karten-Modus (noch keine Bewertung) · 15 Min Richtungen erkennen: 3–5 Stoßrichtungen (gemeinsam bündeln, größter Hebel) · 5 Min Abschluss: welche Richtungen gehen in Phase 3.
- **Wissen vor Werkzeug:** Zwischen Experteninput und den Arten von KI-Unterstützung steht die Folie **Wissen als Grundlage**: Das zentrale Asset ist das digitale Wissen aus Dokumenten, Anwendungen und den Köpfen der Menschen; es ist die Grundlage jeder KI-Nutzung. Bestehende Informationen werden zu Wissen (erfassen · ordnen und prüfen · verknüpfen · bereitstellen) und über verschiedene Wege wieder verfügbar gemacht. Einzelne Funktionen und Werkzeuge sind austauschbar, die Wissensbasis bleibt — deshalb erst das Wissen, dann die Unterstützungsarten.
- **Einordnung der Karten:** Beim Sammeln bekommt jede Karte zwei Marker — worauf sie einzahlt (Wissen · Assistenz · Automatisierung · Analyse) und ihren Zeithorizont (Heute · Morgen · Übermorgen). Die KI schlägt beides für alle Karten auf einmal vor, das Plenum prüft und korrigiert einzelne Karten. Die Verteilung zeigt, wie viel auf die Wissensbasis einzahlt und wie viel reine Werkzeugidee ist; sie geht in die Stoßrichtungen ein.
- Hier passt ein **optionaler Demo-Slot** (z. B. Dokumenten-Generator oder Wissensbasis live), sachlich, ohne Disclaimer. Er läuft nur auf ausdrücklichen Wunsch der Gruppe, dann aber mit **15–30 Min**. In diesem Fall geht die Fragerunde in der Demo auf (Fragen direkt am Beispiel) und der Experteninput wird auf rund 20 Min gestrafft; die Phase bleibt bei 90 Min.
...
- **Einstieg Tag 2 (Folie 04.00, rund 5 Min aus dem ersten Block):** Rückblick Tag 1 live aus dem Protokoll: Poster-Ergebnisse der Phasen 1–3 (Kernproblem, Stoßrichtungen, Leitsatz und Profil), Stimmung aus dem Vorher-Barometer, Zahlen zur geleisteten Arbeit, offene eigene Fragen. Optional fasst die KI Tag 1 in fünf Sätzen zusammen (editierbar im Protokoll). Einstiegsfrage: „Was davon trägt noch? Was sehen wir heute anders?"
...
### Phase 5 · Wirtschaftlichkeit & Argumentation (45 Min) — Modul 5
- **Kernfrage:** Wie argumentieren wir eine solche Lösung gegenüber Entscheidern (Vorstand, Mitgliederversammlung)?
